...
function mathFunction(textToSend, val, adapter) {
    ...
    return error
        ? { textToSend: (0, string_1.normalizeWhitespace)(textExcludeSubstring), calculated: val, error }
        : { textToSend: (0, string_1.normalizeWhitespace)(textExcludeSubstring), calculated: evalVal, error };
}
