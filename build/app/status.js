...
const checkStatus = async (appContext, text) => {
    ...
    const { textToSend, error } = (0, exchangeValue_1.exchangeValue)(appContext, modifiedText, stateValue.val, shouldChangeByStatusParameter);
