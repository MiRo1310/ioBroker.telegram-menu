		...
		part.switch.forEach((/** @type {{ id: string; value: *; toggle:boolean; confirm:Boolean; returnText: string; parse_mode: string }} */ element) => {
			...
			if (!returnText.includes("{'id':'")) {
				...
				try {
					...
					console.log(element.parse_mode);
					sendToTelegram(_this, userToSend, textToSend, undefined, telegramInstance, one_time_keyboard, resize_keyboard, userListWithChatID, parse_mode);
