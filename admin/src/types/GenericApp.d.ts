...
declare class GenericApp<P = {}, S = {}> extends Router<
    import('@iobroker/adapter-react-v5/types').GenericAppProps & P,
    S & import('@iobroker/adapter-react-v5/types').GenericAppState
> {
    ...
    constructor(
        props: import('@iobroker/adapter-react-v5/types').GenericAppProps & P,
        settings: import('@iobroker/adapter-react-v5/types').GenericAppSettings | undefined,
    );
    /**
     * @member {LegacyConnection | AdminConnection}
     */
    socket: any;
    instance: number;
    adapterName: any;
