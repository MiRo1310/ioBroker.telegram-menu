...
const helperText: HelperText = {
    ...
    nav: {
        value: [
            ...
            { text: 'menu:back', info: 'menuBack' },
        ],
        text: [
            { text: "{set:'id':'ID',val,ack}", info: 'setID' },
            { text: "{time.lc,(DD MM YYYY hh:mm:ss:sss),id:'ID'}", info: 'lcTimestamp' },
            { text: "{time.ts,(DD MM YYYY hh:mm:ss:sss),id:'ID'}", info: 'tsTimestamp' },
        ],
    },
    get: {
        text: [
    ...
    set: {
        ...
        values: [
            { text: '{id:ID}', info: 'manuallyValue' },
            { text: '{math:/10}', info: 'math' },
            { text: '{value}', info: 'modifiedSubmenuValue' },
        ],
    },
};
