...
export const tabValues: TabValues[] = [
	// Danach noch generateActions anpassen in action.js
	{
		...
		entries: [
			...
			{ name: "switch_checkbox", val: "false", headline: "Tog", title: "toggle", checkbox: true, width: "3%", required: true },
			{ name: "parse_mode", val: "false", headline: "Par", title: "parseMode", checkbox: true, width: "3%", required: true },
		],
	...
	},
	{
		...
		entries: [
			...
			{ name: "newline_checkbox", val: "true", headline: "New", title: "newlineCheckbox", checkbox: true, width: "3%", required: true },
