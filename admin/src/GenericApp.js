...
const _Router2 = _interopRequireDefault(require('@iobroker/adapter-react-v5/Components/Router'));
const _Utils = _interopRequireDefault(require('@iobroker/adapter-react-v5/Components/Utils'));
const _SaveCloseButtons = _interopRequireDefault(require('@iobroker/adapter-react-v5/Components/SaveCloseButtons'));
const _Confirm = _interopRequireDefault(require('@iobroker/adapter-react-v5/Dialogs/Confirm'));
const _i18n = _interopRequireDefault(require('@iobroker/adapter-react-v5/i18n'));
const _Error = _interopRequireDefault(require('@iobroker/adapter-react-v5/Dialogs/Error'));
...
var GenericApp = /*#__PURE__*/ (function (_Router) {
    ...
    function GenericApp(props, settings) {
            ...
            function (id, obj) {
                if (obj && id === 'system.config') {
                    ...
                    if (_this.socket.systemLang !== (obj === null || obj === void 0 ? void 0 : obj.common.language)) {
                        _this.socket.systemLang =
                            (obj === null || obj === void 0 ? void 0 : obj.common.language) || 'en';
                    ...
                    if (
                        ...
                        !!(
                            obj !== null &&
                            obj !== void 0 &&
                            (_obj$common = obj.common) !== null &&
                            _obj$common !== void 0 &&
                            _obj$common.expertMode
                        )
                    ) {
            ...
            function (message) {
                if (message !== null && message !== void 0 && message.data) {
                    if (message.data === 'updateTheme') {
                        ...
                        console.debug(
                            'Received unknown message: "'.concat(
                                JSON.stringify(message.data),
                                '". May be it will be processed later',
                            ),
                        );
                    }
                }
        ...
        location.tab =
            location.tab ||
            (window._localStorage || window.localStorage).getItem(''.concat(_this.adapterName, '-adapter')) ||
            '';
        ...
        _this.encryptedFields =
            props.encryptedFields ||
            (settings === null || settings === void 0 ? void 0 : settings.encryptedFields) ||
            [];
        ...
        _this.socket = new ConnectionClass(
            _objectSpread(
                ...
                {},
                {
                    ...
                    doNotLoadAllObjects:
                        settings === null || settings === void 0 ? void 0 : settings.doNotLoadAllObjects,
                            ...
                            .then(function (instanceObj) {
                                ...
                                if (!_this.sentryStarted && _this.sentryDSN && sentryEnabled) {
                                    ...
                                    Sentry.init({
                                        dsn: _this.sentryDSN,
                                        release: 'iobroker.'
                                            .concat(instanceObj.common.name, '@')
                                            .concat(instanceObj.common.version),
                                ...
                                waitPromise.then(function () {
                                    if (instanceObj) {
                                        _this.common =
                                            instanceObj === null || instanceObj === void 0
                                                ? void 0
                                                : instanceObj.common;
        ...
        [
            ...
            },
            {
                ...
                value:
                    ...
                    function componentDidMount() {
                        ...
                        (0, _get2['default'])(
                            (0, _getPrototypeOf2['default'])(GenericApp.prototype),
                            'componentDidMount',
                            this,
                        ).call(this);
                    },
            ...
            },
            {
                ...
                value: function getExpertMode() {
                    return (
                        window.sessionStorage.getItem('App.expertMode') === 'true' || !!this._systemConfig.expertMode
                    );
                },
            ...
            },
            {
                ...
                value: function _updateNativeValue(obj, attrs, value) {
                    ...
                    if ((0, _typeof2['default'])(obj[attr]) !== 'object') {
                        throw new Error(
                            'attribute '
                                .concat(attr, ' is no object, but ')
                                .concat((0, _typeof2['default'])(obj[attr])),
                        );
                    }
