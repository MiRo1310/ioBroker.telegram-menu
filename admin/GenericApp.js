...
var GenericApp = /*#__PURE__*/function (_Router) {
  ...
  (0, _createClass2["default"])(GenericApp, [{
    ...
    value: function renderSaveCloseButtons() {
      ...
      }) : null, this.state.confirmClose ? /*#__PURE__*/_react["default"].createElement(_Confirm["default"], {
    ...
    value: function renderHelperDialogs() {
      return /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, this.renderError(), this.renderToast(), this.renderSaveCloseButtons(), this.renderAlertSnackbar());
    }
